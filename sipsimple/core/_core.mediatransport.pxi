    ...
    property zrtp_multistream_parameters:
        ...
        def __get__(self):
            ...
            try:
                ...
                if length > 0:
                    ret = PyUnicode_FromStringAndSize(multistr_params, length)
    ...
    property zrtp_cipher:
        ...
        def __get__(self):
            ...
            try:
                ...
                if zrtp_info == NULL or not bool(zrtp_info.active):
                    return None
                return PyUnicode_FromString(zrtp_info.cipher)
            finally:
                with nogil:
                    pj_mutex_unlock(lock)
        ...
        def __get__(self):
            ...
            try:
                ...
                if status <= 0:
                    ...
                    return PyUnicode_FromStringAndSize(<char*>name, 12)
            finally:
                with nogil:
                    pj_mutex_unlock(lock)
...
cdef ICECandidate ICECandidate_create(pj_ice_sess_cand *cand):
    ...
    address = PyUnicode_FromString(buf)
    ...
    if pj_sockaddr_has_addr(&cand.rel_addr):
        ...
        rel_addr = PyUnicode_FromString(buf)
    else:
        rel_addr = ''
